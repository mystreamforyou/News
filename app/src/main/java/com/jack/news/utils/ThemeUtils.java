...
public class ThemeUtils {
    ...
    private static void saveTheme(Context context, Theme theme) {
        SharedPreferences preferences = context.getSharedPreferences(AppConfig.SHARE_PREFERENCES_NAME, Context.MODE_PRIVATE);
...
//            textView.setChecked(true);
    ...
    private static String getString(int resid) {
        return NewsApp.getInstance().getString(resid);
    }
